  ...
  return (
    <div className="max-w-2xl">
          ...
          {keys.map((k) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`text-xs ${k.active ? "text-green-600" : "text-gray-400"}`}
                >
                  {k.active ? "활성" : "폐기됨"}
                </span>
                {k.active && (
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        <h3 className="font-medium text-sm mb-2">외부 API 사용법</h3>
        <pre className="text-xs text-gray-600 overflow-x-auto">{`curl -X POST /api/external/chat \\
