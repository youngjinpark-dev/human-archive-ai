...
export default function StorePage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">페르소나 스토어</h1>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-6">
        ...
        <select
          ...
          className="ml-auto px-3 py-1 border border-gray-300 rounded-lg text-sm outline-none"
        >
          ...
          {hasMore && (
            <div className="mt-6 text-center">
              <button
                ...
                disabled={loading}
                className="px-6 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 disabled:opacity-50 transition"
              >
                {loading ? "로딩 중..." : "더 보기"}
              </button>
            </div>
